...
- The only outbound webhook events Kajabi fires are `purchase.created`, `payment.succeeded`, and `cart.purchase`. **There is no webhook for subscription cancellation, pause, or payment failure.**
